...
import image5 from '../../images/black-mouse.jpg'
  ...
  const navigate = useNavigate();
	...
	return (
		<div className={styles.bigcardcomponent}>
			...
			<BigCard title="Clothes" image={image2}  clickHandler={clickHandler}/>
			<BigCard title="Meals" image={meals} clickHandler={clickHandler}/>
			<BigCard title="Toys" image={image3} clickHandler={clickHandler}/>
			<BigCard title="Shoes" image={image4} clickHandler={clickHandler}/>
			<BigCard title="Electronics" image={image5} clickHandler={clickHandler}/>
			<BigCard title="Home Foods" image={image6} clickHandler={clickHandler}/>
			<BigCard title="Mobiles" image={mobile}  clickHandler={clickHandler}/>
			<BigCard title="Bike Parts" image={mobile} />
			<BigCard title="Electrical Things" image={mobile} clickHandler={clickHandler}/>
